...
#define	ANM_MAX_SLOTS	(8)//(64+32)	// Airball : Pas d'anims ou presque.
...
// Reset de l'anim en cours.
void AnmReset(s32 nSlotNo)
{
	SLOT_ERR2(AnmReset)
	AnmSet(pAnmSlots[nSlotNo].pOrg, nSlotNo);
}
